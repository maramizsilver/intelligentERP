// src/pages/ventes/Commandes.jsx
    ...
    <div>
      <div style={styles.header}>
        <div>
          ...
          <p style={styles.subtitle}>Gérez toutes les commandes de votre entreprise</p>
        </div>
      ...
      {showForm && (
        <Card title= "Nouvelle commande" variant="primary" style={{ marginBottom: '24px' }}>
          <form onSubmit={handleSubmit}>
            ...
            <Button type="submit" variant="primary" loading={formLoading} icon="✅" fullWidth>
              Créer la commande
            </Button>
          </form>
        </Card>
