...
export default function PaiementClientSuccess() {
  ...
  return (
    <div style={styles.container}>
      <Card title="Paiement reussi" variant="success">
        <div style={styles.content}>
          <h2 style={styles.title}>Merci pour votre paiement !</h2>
          <p style={styles.text}>Votre paiement a ete effectue avec succes.</p>
